          ...
          <div className={`lg:w-1/2 lg:pr-12 mb-12 lg:mb-0 transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
            <div className="space-y-8">
              ...
              <div className={`flex space-x-4 transform transition-all duration-700 delay-900 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-full shadow-lg shadow-blue-400/25 hover:shadow-xl hover:shadow-blue-400/40 transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                ...
                <button className="group relative px-8 py-4 bg-transparent border-2 border-blue-400 text-blue-400 font-semibold rounded-full hover:bg-blue-400 hover:text-white transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
