...
const parseFundingAmount = (benefits) => {
  ...
  const topSchemes = sortedSchemes.filter(scheme => scheme.eligibilityScore >= 90).slice(0, 3);
          ...
          <div className="mb-10">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg mt-2">Curated schemes tailored to your needs</p>
              </div>
            </div>
